...
//
//     final getInfoTrainer = getInfoTrainerFromJson(jsonString);

import 'dart:convert';

GetAllTrainerFeed getInfoTrainerFromJson(String str) => GetAllTrainerFeed.fromJson(json.decode(str));

String getInfoTrainerToJson(GetAllTrainerFeed data) => json.encode(data.toJson());

class GetAllTrainerFeed {
  GetAllTrainerFeed({
    this.status,
    this.message,
    this.code,
  ...
  factory GetAllTrainerFeed.fromJson(Map<String, dynamic> json) => GetAllTrainerFeed(
    status: json["status"],
