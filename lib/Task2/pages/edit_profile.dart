...
import 'BottomNavPages/bottom_bar.dart';
...
class _ProfilePageState extends State<EditProfile> {
            ...
            onTap: () {
              ...
              if (updateProfile()) {
                ...
                apiServices.updateUserProfile(
                    Constants.updateUserProfileModel, pathImage);
              ...
              child: Form(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    10.heightBox,
                    buildEditTextColumn(snapshot).px(16.0),
                    20.heightBox,
                    const Divider(
                      thickness: 2,
                    ),
  ...
  Column buildEditTextColumn(AsyncSnapshot<ViewProfileResponse> snapshot) {
    return Column(
      children: [
        TextFormField(
          initialValue: snapshot.data.data.username,
          keyboardType: TextInputType.text,
          onSaved: (input) => Constants.updateUserProfileModel.username = input,
        ...
        TextFormField(
          ...
          onSaved: (input) => Constants.updateUserProfileModel.email = input,
          decoration: const InputDecoration(
        ...
        TextFormField(
          ...
          keyboardType: TextInputType.text,
          onSaved: (input) => Constants.updateUserProfileModel.bio = input,
          decoration: const InputDecoration(
        ...
        TextFormField(
          ...
          onSaved: (input) => Constants.updateUserProfileModel.phoneNo = input,
          decoration: const InputDecoration(
